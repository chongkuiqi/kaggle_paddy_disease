...
def dataset_fn(root_dir, img_size):
...
def create_dataloader(data_path, img_size, shuffle=False, batch_size=1, num_workers=8):

    dataset = dataset_fn(data_path, img_size)
